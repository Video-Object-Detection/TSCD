...
def make_parser():
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default='./../exps/AM-DVOD/ovis_v++_base_decoupleReg.py',
        type=str,
    ...
    parser.add_argument("-c", "--ckpt", default='./../OVIS_YOLOX_outputs/baseline/ovis_yolox_s/best_ckpt.pth', type=str, help="checkpoint file")
