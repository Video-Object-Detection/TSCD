...
# from ..ops_dcnv3.modules import DCNv3, DCNv3_pytorch, DCNv4
...
# class DeformableCNv4(nn.Module):
#     """
#         Deformable Conv v4
#     """
...
#         # same padding
#         pad = (ksize - 1) // 2
#         self.dcnv4 = DCNv4(out_channels, kernel_size=ksize, stride=stride, pad=pad, group=groups)
#         self.bn = nn.BatchNorm2d(out_channels)
#         self.act = get_activation(act, inplace=True)
#
#     def forward(self, x):
...
#
#
# class DeformableCNv3(nn.Module):
#     """
#         Deformable Conv v3
#     """
#     def __init__(self, in_channels, out_channels, ksize, stride, groups=1, bias=False, act="silu"):
...
#         # same padding
#         pad = (ksize - 1) // 2
#         self.dcnv3 = DCNv3(out_channels, kernel_size=ksize, stride=stride, pad=pad, group=groups)
#         # self.dcnv3 = DCNv3_pytorch(out_channels, kernel_size=ksize, stride=stride, pad=pad, group=groups)
#         self.bn = nn.BatchNorm2d(out_channels)
#         self.act = get_activation(act, inplace=True)
#
#     def forward(self, x):
...
#         # same padding
#         pad = (ksize - 1) // 2
#         self.dcnv4 = DCNv4(out_channels, kernel_size=ksize, stride=stride, pad=pad, group=groups, use_dcn_v4_op=True)
#         # self.dcnv4 = DCNv4_pytorch(out_channels, kernel_size=ksize, stride=stride, pad=pad, group=groups)
#         self.bn = nn.BatchNorm2d(out_channels)
#         self.act = get_activation(act, inplace=True)
#
#     def forward(self, x):
