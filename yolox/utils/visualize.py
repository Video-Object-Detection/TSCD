...
def vis(img, boxes, scores, cls_ids, conf=0.5, class_names=None,t_size = 2):
    """
    ...
    for i in range(len(boxes)):
        ...
        txt_size = cv2.getTextSize(text, font, t_size, 3)[0]
        ...
        cv2.putText(img, text, (x0, y1 + 8 + txt_size[1]), font, t_size, txt_color, thickness=5)
