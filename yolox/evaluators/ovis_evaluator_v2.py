...
from yolox.evaluators.coco_evaluator import per_class_AR_table, per_class_AP_table, per_class_AP50_table
import torch
...
ovis_classes = (
    'Person', 'Bird', 'Cat', 'Dog', 'Horse', 'Sheep', 'Cow', 'Elephant', 'Bear', 'Zebra', 'Giraffe', 'Poultry',
    'Giant_panda', 'Lizard', 'Parrot', 'Monkey', 'Rabbit', 'Tiger', 'Fish', 'Turtle', 'Bicycle', 'Motorcycle',
...
class OVISEvaluator:
    ...
    def __init__(
        ...
        self.vid_to_coco = {
            ...
            'annotations': [],
            'categories': [{"supercategory": "object", "id": 0, "name": "Person"},
                           {"supercategory": "object", "id": 1, "name": "Bird"},
                           {"supercategory": "object", "id": 2, "name": "Cat"},
                           {"supercategory": "object", "id": 3, "name": "Dog"},
                           {"supercategory": "object", "id": 4, "name": "Horse"},
                           {"supercategory": "object", "id": 5, "name": "Sheep"},
                           {"supercategory": "object", "id": 6, "name": "Cow"},
                           {"supercategory": "object", "id": 7, "name": "Elephant"},
                           {"supercategory": "object", "id": 8, "name": "Bear"},
                           {"supercategory": "object", "id": 9, "name": "Zebra"},
                           {"supercategory": "object", "id": 10, "name": "Giraffe"},
                           {"supercategory": "object", "id": 11, "name": "Poultry"},
                           {"supercategory": "object", "id": 12, "name": "Giant_panda"},
                           {"supercategory": "object", "id": 13, "name": "Lizard"},
                           {"supercategory": "object", "id": 14, "name": "Parrot"},
                           {"supercategory": "object", "id": 15, "name": "Monkey"},
                           {"supercategory": "object", "id": 16, "name": "Rabbit"},
                           {"supercategory": "object", "id": 17, "name": "Tiger"},
                           {"supercategory": "object", "id": 18, "name": "Fish"},
                           {"supercategory": "object", "id": 19, "name": "Turtle"},
                           {"supercategory": "object", "id": 20, "name": "Bicycle"},
                           {"supercategory": "object", "id": 21, "name": "Motorcycle"},
                           {"supercategory": "object", "id": 22, "name": "Airplane"},
                           {"supercategory": "object", "id": 23, "name": "Boat"},
                           {"supercategory": "object", "id": 24, "name": "Vehical"}],
            'images': [],
            'licenses': []
        }
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, label, path, time_embedding) in enumerate(
            ...
            with torch.no_grad():
                ...
                time_embedding = time_embedding.type(tensor_type)
                # Determining whether it is the first frame of the video during mixed local and global training
                if self.lframe == 0 or int(path[0].split('/')[-1].split('.')[0].split('_')[-1]) == 0:
                    resume = False
                else:
                    resume = True
